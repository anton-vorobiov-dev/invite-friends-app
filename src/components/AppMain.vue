<template>
  <main class="app-main">
    <article class="app-main__card">
      <img src="@/assets/images/img-1.png" alt="More Bonuses" class="card__image" />
      <div class="card__actions">
        <AppButton class="card__button"><span>More Bonuses</span></AppButton>
      </div>
    </article>
    <article class="app-main__card">
      <img src="@/assets/images/img-2.png" alt="Invite" class="card__image" />
      <div class="card__actions">
        <AppButton class="card__button" theme="blue"><span>Invite</span></AppButton>
        <AppButton class="card__button" theme="blue">
          <svg
            version="1.1"
            id="_x32_"
          ...
          >
            <g>
              <path
                ...
                fill="#D0EEFF"
                stroke-width="12"
                d="M509.681,102.798c-4.641-24-16.344-47.141-34.875-65.578C462.462,24.86,448.087,15.501,432.79,9.298
		...
		l98.609-98.594c12.313-12.328,21.688-26.719,27.891-42.047C512.009,151.813,514.306,126.782,509.681,102.798z"
              ...
              <path
                ...
                stroke-width="16"
                class="st0"
                d="M230.259,366.907c-0.188-0.094-0.313-0.125-0.469-0.188l-60.516,60.531
